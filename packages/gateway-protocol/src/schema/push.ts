...
export const WebPushPreferencesSetParamsSchema = closedObject({
  endpoint: Type.String({ minLength: 1, maxLength: 2048, pattern: "^https://" }),
  scope: Type.String({ enum: ["user", "device"] }),
  preferences: Type.Union([WebPushNotificationPreferencesSchema, WebPushDevicePreferencesSchema]),
});
