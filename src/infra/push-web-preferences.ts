...
export const DEFAULT_WEB_PUSH_NOTIFICATION_PREFERENCES: WebPushNotificationPreferences = {
  categories: {
...
export const DEFAULT_WEB_PUSH_DEVICE_PREFERENCES: WebPushDevicePreferences = {
  enabled: true,
  label: "",
};
...
export function webPushCategoryEnabled(
  ...
  return Boolean(key && preferences.enabled && preferences.categories[key]);
}
